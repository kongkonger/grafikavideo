...
import com.android.grafika.encoder.MediaAudioEncoder;
import com.android.grafika.encoder.MediaEncoder;
...
//        File outputFile = new File(getFilesDir(), "camera-test.mp4");
        File outputFile = new File(getSDCardPath(), "camera-test.mp4");
