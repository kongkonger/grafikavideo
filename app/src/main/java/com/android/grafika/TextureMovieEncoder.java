...
//    private static final int MSG_START_RECORDING = 0;
    ...
    private static final int MSG_PREPARE_RECORDING = 0;
...
//    }
    ...
    public void prepareRecording(EncoderConfig config) {
        ...
        mHandler.sendMessage(mHandler.obtainMessage(MSG_PREPARE_RECORDING, config));
    }
...
//                    encoder.handleStartRecording((EncoderConfig) obj);
                    encoder.prepareEncoder((EncoderConfig) obj);
                    break;
...
//    }
    ...
    public void prepareEncoder(EncoderConfig config) {
        Log.d(TAG, "handleStartRecording " + config);
        mFrameNum = 0;
        prepareEncoder(config.mEglContext, config.mWidth, config.mHeight, config.mBitRate,
                config.mOutputFile);
    ...
    public void startVideoRecording(){
        ...
        mIsStarted= true;//专门控制开始的变量
        if(null != mVideoEncoder){
            mVideoEncoder.setIsCapturing(true);
        }
    }
